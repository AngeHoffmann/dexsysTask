# Тестовое задание для Java-курсов в Dexsys IT 2019
...
если какой-то из списков пустой, то необходимо напечатать сообщение 
"Список type пуст" при выводе списка с помощью команд Print.
```
